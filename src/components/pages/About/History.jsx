        ...
        <div className="sm:flex sm:flex-row font-serif pt-3 ">
          ...
          <div>
            <h1 className=" sm:max-w-[75vw] ml-[2vw] sm:text-[1.2vw] text-[5vw] ">
              ...
              see Karateka (video game). Karate (空手) Chōmo Hanashiro, an
              ...
              Indigenous martial arts of Ryukyu Islands, Chinese martial
              arts[1][2] <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              Karate WKF's Karate World Championship 2006 in Tampere, Finland;
              men's heavyweight final Highest governing body World Karate
              Federation First developed Ryukyu Kingdom, ca. 17th century
             ...
             Japanese name Kanji 空手
              Hiragana からて Katakana カラテ Transcriptions Karate (空手)
              (/kəˈrɑːti/; Japanese pronunciation: [kaɾate] ⓘ; Okinawan
              pronunciation: [kaɽati]), also karate-do (空手道, Karate-dō), is a
              ...
              [1][2] While
              modern karate is primarily a striking art that uses punches and
              kicks, traditional karate also employs throwing and joint locking
              techniques.[3] A karate practitioner is called a karate-ka
              (空手家). <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The
              Ryukyu Kingdom had been conquered by the Japanese Satsuma Domain
              and had become its vassal state since 1609, but was formally
              annexed to the Empire of Japan in 1879 as Okinawa Prefecture. The
              Ryukyuan samurai (Okinawan: samurē) who had been the bearers of
              karate lost their privileged position, and with it, karate was in
              danger of losing transmission. However, karate gradually regained
            ...
            and 
              ...
              <span>Motobu Chōki.</span>
                ...
                Karate's
              popularity was initially sluggish with little exposition but when
              a magazine reported a story about Motobu defeating a foreign boxer
              in Kyoto, karate rapidly became well known throughout Japan.[4]
            </h1>
          </div>
        </div>
        ...
        <div className="sm:flex sm:flex-row font-serif pt-[2vw]">
          <div>
            <h1 className="sm:max-w-[75vw] ml-[1vw] sm:text-[1.2vw] text-[4vw] ">
              ...
              beginning students. In 1905, Itosu helped to get karate introduced
              into Okinawa's public schools. These forms were taught to children
              at the elementary school level. Itosu's influence in karate is
              broad. The forms he created are common across nearly all styles of
          ...
          <div>
            <img className="sm:w-[20vw] w-[85vw] sm:ml-[1vw] ml-[7vw] " src={h1} alt="img2" />
          </div>
        </div>
      </div>
    </div>
